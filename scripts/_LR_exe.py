...
parser = argparse.ArgumentParser(description='LR_SVR_exe')
parser.add_argument('--model_name', type=str, default='LR', help='The model used for prediction.')
...
parser.add_argument('--record_path', type=str, default='./results/LR_record.xlsx', help='The path to save the training record.')
...
"Ridge": Ridge(**shared_params,alpha=l2_ratio),
"Lasso": Lasso(**shared_params,alpha=l1_ratio),
"ElasticNet": ElasticNet(**shared_params,alpha=l1_ratio+l2_ratio,l1_ratio=l1_ratio/(l1_ratio+l2_ratio)), # See https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNet.html for parameter definition.
}
